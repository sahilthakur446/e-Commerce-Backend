...
namespace eCommerce.Data.Repository.Interface
    ...
    public interface IProductRepository
        ...
        Task<ProductInfoDTOWithPagination> GetAllProductsUsingPaginationAsync(int currentPage, int pageSize);
        ...
        Task<ProductInfoDTOWithPagination> GetProductsWithFiltersWithPaginationAsync(int currentPage, int pageSize, int? minPrice, int? maxPrice, string? category, int? categoryId, int? brandId, string? gender, bool isNew);
